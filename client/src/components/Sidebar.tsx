...
function PitchIcon() {
  return (
    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="3" width="20" height="18" rx="2"/><circle cx="12" cy="12" r="3.5"/>
...
const NAV_ITEMS = [
  ...
  { to: '/squad',       label: 'Build Squad', Icon: PitchIcon    },
  { to: '/my-squad',   label: 'My Squad',    Icon: SquadIcon    },
...
export default function Sidebar() {
  ...
  return (
    <aside style={{
      ...
      background: 'linear-gradient(180deg, #080c18 0%, #070a14 100%)',
      ...
      <div style={{ padding: '20px 18px 18px', borderBottom: '1px solid rgba(255,255,255,0.05)', flexShrink: 0 }}>
        <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none' }}>
          <div style={{
            ...
            background: 'rgba(0,255,135,0.1)', border: '1px solid rgba(0,255,135,0.18)',
        ...
        <div style={{ marginTop: '10px', display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '9.5px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.18em' }}>
            FIFA World Cup 2026
          </span>
        </div>
      </div>
      ...
      <div style={{ flex: 1, padding: '16px 12px', overflowY: 'auto', minHeight: 0 }}>
        <p style={{
          color: 'rgba(255,255,255,0.18)', fontSize: '9px', fontWeight: 800,
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  textDecoration: 'none',
                  color: active ? '#00FF87' : 'rgba(255,255,255,0.42)',
                  background: active ? 'rgba(0,255,135,0.08)' : 'transparent',
                  border: `1px solid ${active ? 'rgba(0,255,135,0.15)' : 'transparent'}`,
        ...
        {connected && publicKey && (
          <div style={{
            ...
            <div style={{
              ...
              background: 'rgba(0,255,135,0.15)', border: '1px solid rgba(0,255,135,0.2)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
            }}>
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#00FF87" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <p style={{ color: '#fff', fontSize: '11px', fontWeight: 700, fontFamily: 'monospace', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
