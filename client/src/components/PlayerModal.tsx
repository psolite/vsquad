      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          <div style={{
            ...
            border: `3px solid ${colors.secondary === '#FFFFFF' ? 'rgba(255,255,255,0.2)' : colors.secondary}`,
            overflow: 'hidden',
            margin: '0 auto 16px',
          ...
          <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: '13px', margin: 0 }}>
            {positionLabel[player.position]} · {player.country}
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '20px' }}>
          {[
            { value: player.goals, label: "Int'l Goals" },
            { value: player.caps,  label: 'Caps' },
          ].map(({ value, label }) => (
            <div key={label} style={{
        ...
        {canAdd ? (
          <button
            ...
            style={{
              ...
              fontWeight: 900, fontSize: '13px', textTransform: 'uppercase', letterSpacing: '0.1em',
            }}
