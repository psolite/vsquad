...
export default function Pitch({ squad, selectedSlot, onSlotClick }: Props) {
  ...
  return (
    <div className="relative w-full h-full rounded-xl overflow-hidden select-none" style={{ background: 'linear-gradient(180deg, #2e7d32 0%, #388e3c 30%, #2e7d32 60%, #388e3c 100%)', minHeight: 0 }}>
