...
router.get('/:wallet', async (req: Request, res: Response) => {
  const record = await getSquad(req.params.wallet)
...
router.patch('/:wallet/lock', async (req: Request, res: Response) => {
  const ok = await lockSquad(req.params.wallet)
...
router.delete('/:wallet', async (req: Request, res: Response) => {
  const ok = await deleteSquad(req.params.wallet)
