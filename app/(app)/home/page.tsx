...
function PositionBadge({ pos }: { pos: string }) {
  ...
  return <span style={{ background: bg, border: `1px solid ${color}33`, color, fontSize: '9px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em', padding: '2px 7px', borderRadius: '5px' }}>{pos}</span>
}
