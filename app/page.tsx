...
export default function LandingPage() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center overflow-hidden" style={{ background: 'radial-gradient(ellipse 80% 60% at 50% 40%, #0b2a18 0%, #060d0a 55%, #040809 100%)', minHeight: '100vh' }}>
      ...
      <div className="absolute pointer-events-none" style={{ width: '700px', height: '350px', top: '50%', left: '50%', transform: 'translate(-50%, -60%)', background: 'radial-gradient(ellipse, rgba(0,255,135,0.09) 0%, transparent 70%)', filter: 'blur(48px)' }} />
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full max-w-2xl px-6" style={{ gap: '1.25rem' }}>
        ...
        <div className="flex flex-col items-center" style={{ gap: '0.5rem' }}>
          <p className="text-white/45 font-semibold uppercase" style={{ fontSize: 'clamp(12px, 2vw, 15px)', letterSpacing: '0.22em' }}>5-a-side Fantasy Football</p>
